...
export default class MyOrders extends React.Component {
    ...
    componentDidMount(){
        ...
        axios.post("https://hodahanafy.000webhostapp.com/Restaurant/Restaurant_MyOrder.php",data_to_send).then(res=>{
            if (res.status ==200){
...
<Text style={{ fontSize: 22, fontWeight: 'bold', }}>My Order</Text>
<TouchableOpacity
    onPress={() => {
